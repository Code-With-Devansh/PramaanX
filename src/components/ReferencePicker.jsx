...
function ReferencePicker({ label, items, forbidden, loading, value, onChange, required }) {
  if (forbidden) {
    return (
      <Input
        label={label}
...
export function OrgPicker({ value, onChange, label = "Organization", required }) {
...
export function JurisdictionPicker({ value, onChange, label = "Jurisdiction", required }) {
